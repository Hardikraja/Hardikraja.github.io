var vanillaCalendar = {
	...
	dateClicked: function () {
		...
		for (var e = 0; e < this.activeDates.length; e++) this.activeDates[e].addEventListener("click", function (e) {
			document.querySelectorAll('[data-calendar-label="picked"]')[0].innerHTML = todate1(this.dataset.calendarDate), t.removeActiveClass(), this.classList.add("vcal-date--selected")
		})
...
var todate1 = function (date1){
    var today = new Date(date1);
var dd = String(today.getDate()).padStart(2, '0');
var mm = String(today.getMonth() + 1).padStart(2, '0'); //January is 0!
var yyyy = today.getFullYear();
today = dd + '/' + mm + '/' + yyyy;
document.getElementById('dateselecttx').value = today;
return today;
